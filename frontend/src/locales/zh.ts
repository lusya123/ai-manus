export default {
  ...
  'Connection lost. Please retry.': '连接已中断，请重试。',
  'Failed to restore session. Please retry.': '恢复会话失败，请重试。',
  'Failed to stop task. It may still be running; please try again.': '停止任务失败，任务可能仍在运行，请重试。',
  'Task has already stopped': '任务已经停止',
  'Live updates stopped while the task may still be running. Refresh this page or stop the task.': '实时更新已停止，但任务可能仍在运行。请刷新页面或停止任务。',
  ...
  'Are you sure you want to delete Claw?': '确定要删除 Claw 吗？',
  ...
  'Enter provider': '输入供应商',
  'API Base URL': 'API Base URL',
  'API Key': 'API Key',
  'Enter API key': '输入 API Key',
  'Show API key': '显示 API Key',
  'Hide API key': '隐藏 API Key',
  'New chats use system default': '新对话使用系统默认',
  'New chats use {model}': '新对话使用 {model}',
  'New chats use custom model': '新对话使用自定义模型',
  'Save to use system default for new chats': '保存后新对话使用系统默认',
  'Save to use {model} for new chats': '保存后新对话使用 {model}',
  'Reset': '重置',
  'Model settings reset': '模型设置已重置',
  ...
  'Change the password used to sign in to this account.': '修改用于登录此账户的密码。',
  'Use at least 6 characters for your new password.': '新密码至少需要 6 个字符。',
  ...
  'Chat Freely via Manus': '通过 Manus 自由对话',
  'Auto-configured with powerful LLMs and skill libraries, supports multiple chat tools, proactively completes various tasks': '自动配置强大的大模型与实用技能库，支持多种聊天工具，主动完成各种任务',
  'Get Started': '立即开始',
  'Create Manus Claw': '创建 Manus Claw',
  'One-click OpenClaw deployment by Manus': 'Manus 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
  'Claw is initializing, please wait...': 'Claw 正在初始化，请稍候...',
  'Claw is ready, let\'s chat!': 'Claw 创建完成，开始聊天吧～',
  'Claw has stopped': 'Claw 已停止',
  'Recreate': '重新创建',
  'Claw failed to start': 'Claw 启动失败',
  'Claw failed to start, please recreate.': 'Claw 启动失败，请重新创建。',
